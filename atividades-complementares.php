    ...
    <div class="events-container">
        ...
        <div class="item">
            <object class="file__embed"
                data="public/docs/REGULAMENTO DAS ATIVIDADES COMPLEMENTARES.pdf"
                type="application/pdf"
                aria-label="REGULAMENTO DE ATIVIDADES COMPLEMENTARES 2024">
            </object>
        </div>
        <div class="link">
            <a href="public/docs/REGULAMENTO DAS ATIVIDADES COMPLEMENTARES.pdf" target="_blank">Regulamento de Atividades Complementares</a>
        </div>
    
        <br><br><br>
    
        <p><strong>Instruções para o envio dos comprovantes de atividades</strong></p>
    
        <div class="item">
            <object class="file__embed"
                data="public/docs/Atividades Complementares FACX 2024.pdf"
                type="application/pdf"
                aria-label="Atividades Complementares FACX">
            </object>
        </div>
        <div class="link">
            <a href="public/docs/Atividades Complementares FACX 2024.pdf" target="_blank">Instruções</a><br><br>
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdtX8cO83mVHqJYRtuhFDYZIDZAlxcy2hWfIfcOP9zYACEjSw/viewform?usp=sf_link" target="_blank">Enviar atividade</a>
        </div>
